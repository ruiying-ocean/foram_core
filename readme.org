...
This project aims to collect and sort out existing foraminifera census data in the Last Glacial Maximum (21 ka).
+ Author: Rui Ying (rui.ying@bristol.ac.uk)
+ Publication citation: in preparation
...
* Data Sources
** [[file:raw/RAEDME.txt][Foraminifera data]]
** LGM Temperature
