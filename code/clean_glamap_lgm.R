...
glamap <- read_csv("raw/LGM_GLAMAP.csv")%>% replace_na_with_zero()
...
glamap <- glamap %>% replace_column_name("N. pachyderma d", "N. pachyderma")
...
glamap <- glamap %>% replace_column_name("N. pachyderma s", "N. incompta")
